...
(define (problem fifteen-puzzle-example)
  ...
  (:init
   ...
   (not(IS-removed tile1))
   (not(IS-removed tile2))
   (not(IS-removed tile3))
   (not(IS-removed tile4))
   (not(IS-removed tile5))
   (not(IS-removed tile6))
   (not(IS-removed tile7))
   (not(IS-removed tile8))
   (not(IS-removed tile9))
   (not(IS-removed tile10))
   (not(IS-removed tile11))
   (not(IS-removed tile12))
   (not(IS-removed tile13))
   (not(IS-removed tile14))
   (not(IS-removed tile15))
   (not(tile-removed))
